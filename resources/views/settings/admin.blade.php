                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        <div class="row pt-2">
                                                                            <label class="pb-2"
                                                                                for="is_manually_enabled">{{ __('Requesting manual payment for the planned
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            <label for="google_recaptcha_key"
                                                class="form-label">{{ __('Google Recaptcha
                                                                                            Key') }}</label>
                                            <input class="form-control"
                                ...
                                <div class="s3-setting row {{ $setting['storage_setting'] == 's3' ? ' ' : 'd-none' }}">
                                    ...
                                    <div class=" row ">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-label"
                                                    for="s3_max_upload_size">{{ __('Max upload size (
                                                                                                    In KB)') }}</label>
                                ...
                                <div
                                    ...
                                    <div class=" row ">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-label"
                                                    for="wasabi_root">{{ __('Max upload size ( In
                                                                                                    KB)') }}</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('pusher_app_id', $settings['pusher_app_id'], ['class' => 'form-control font-style']) }}
                                        @error('pusher_app_id')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        ...
                                        <a href="#location-list" class="btn btn-sm btn-primary" data-ajax-popup="true"
                                            data-size="md" data-title="{{ __('Add Country') }}"
